function psdtradtr(action)
%psdtradtr:     reads or writes the values of the signals of the controller.
                ...
                switch ACQCTRL_SERVICE
                    case 'CLASSIC'
                        if strcmp(D_Status,'Not initialized');
                            ...
                            P_Mast.MST_DI1_IN=P_MastConn.GetMemory('MST_DI_1_IN');
                            ...
                            for iCon=1:S_Mast.NCon
                                P_Mast.C_ALGO(iCon)=P_MastConn.GetMemory(['C' num2str(iCon) '_ALGO']);
                            end
