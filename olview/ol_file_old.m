...
global S_EndStep S_NMast S_MastAddress S_NConMast S_NDofMast;
global S_NPattMast S_NGAccMast S_NSRMast;   
  ...
  case 'Open a test';
    ...
    if file1==0;
      ...
      [S_TestTitle,S_TestProc,S_ToolProc,S_ControlParam, ...
          S_EndStep,S_NMast,S_MastAddress,S_NConMast,S_NDofMast, ...
          S_NPattMast,S_NGAccMast,S_NSRMast]=feval([S_TestName '_test']);
