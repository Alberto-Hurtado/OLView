...
global ALGORAV ALGOR_T ALGORUSERINPUT STEPVAR STEPSTATUS  %psdtrad
% global ALGORAV ALGOR_T ALGORUSERINPUT ALGOIREC   %psdcyc
    ...
    case 'Real data transmission';
        switch action;
            case 'initialize'
                ...
                Block.constant.varNames={'DllName' 'TestName'};
...
%                 Blocks=[Blocks(:)' {Block}];
                ...
                Block.name='STEPVAR';
                Block.memoryName=Block.name;
                Block.scalar.varNames={'lAverageNumber'};
                Blocks=[Blocks(:)' {Block}];
                               
                Block={};
                Block.node='Mast';
                Block.name='STEPSTATUS';
                Block.memoryName=Block.name;
                Block.scalar.varNames={'lCurrentStep' 'lCurrentSubStep' 'lNbrSubSteps' 'lLatencyTicks'};
                Blocks=[Blocks(:)' {Block}];
...
%                 Block.scalar.varNames={'Count_t' 'Time_t' 'TimeIncr' 'EneAbs_t' 'EneErr_t'};
                Block.scalar.varNames={'lCurrentSubStep_t'};
%                 Block.vect(1).lengthName='S_Mast.NDof';
%                 Block.vect(1).varNames={'Dis_t' 'Res_t'};
                Block.vect(1).lengthName='S_Mast.NCon';
                Block.vect(1).varNames={'Heid_t' 'LCell_t' 'ConTarget_t' 'Force2_t' 'Speed_t' 'Lvdt_t'};
                Block.vect(2).lengthName='S_Mast.NPatt';
                Block.vect(2).varNames={'Patt_t'};
                Blocks=[Blocks(:)' {Block}];
