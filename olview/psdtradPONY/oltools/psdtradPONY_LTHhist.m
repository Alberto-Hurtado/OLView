...
global S_Status S_Step;
global S_TestName S_TestTitle;
global S_Mast ALGORAV ALGOR_T ALGORUSERINPUT STEPSTATUS STEPVAR;
...
itr=1;
for iM=1:M(itr)
  set(ToolStruct.TR(itr).line(iM),'xdata',STEPSTATUS.lCurrentStep(1:N)', ...
...
title(sprintf('%s: %s.   CurrentStep:%5g',ALGORUSERINPUT(1).TestName,S_TestTitle, ...
    STEPSTATUS.lCurrentStep(N)));
