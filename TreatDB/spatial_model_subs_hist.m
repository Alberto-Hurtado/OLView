...
%                  history from displacement and restoring force dynamic history.
%
%       [freq,zeta,K,C,off,t]=spatial_model_hist(d,r,M,Dt,Npwin,Npjump)
%
%   NDoF                    Number of degrees of freedom (experimental substructure).
%   Np                      Number of input time instants.
%   Dt                      Time increment for input histories d and r (s).
%   d(Np,NDoF)              Displacement vector history (experimental substructure).
%   r(Np,NDoF)              Restoring force vector history (experimental substructure).
%
%   NGlDoF                  Number of degrees of freedom (global structure).
%   M(NGlDoF,NGlDoF)        Mass matrix (global structure).
%
...
%   freq(Np_id,NGlDoF)        Identified frequencies (Hz).
%   zeta(Np_id,NGlDoF)        Identified viscous equivalent damping ratios (%). 
%   K(NGlDoF,NGlDoF,Np_id)      Identified secant stiffness matrix.
