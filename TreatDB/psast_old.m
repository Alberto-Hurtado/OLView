function [PSAst,freqst,periodst,SDst,PSVst]=psast(AGst,timest,zetalist,fmax,delf,notail)
% function [PSAst,freqst,periodst,SDst,PSVst]=psast(AGst,PSAst,timest,zetalist,fmax,delf,notail)
%
