...
%         print(ii,'-djpeg',graphlist{ii}); %create graph file
        ...
        saveas(ii,graphlist{ii},'fig'); %create graph file 2014
    end
    cd(pwd1);
    ...
    case {'create and save + DB' 'save + DB'};
        ...
        putdocu(graphlist,'.fig',descrl,patGraphics,'Graphics', ...  %2014
            project, structure, experiment); %save graphs in DB      %2014
